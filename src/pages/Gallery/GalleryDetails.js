...
class GalleryDetails extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            hit: null,
            id: this.props.match.params.id // Utilisation de match pour obtenir l'ID de l'URL
            // id: ''
        }
    }
    ...
    render() {
        return (
            <div className="row">
                {/*Logique de rendu basée sur l'etat de la requete*/}
                <div className="col-md-4" key={this.props.hit.id}>
                    <div className="card">
                        <div className="card-header">{this.props.tags} | <strong>Resolution
                            : </strong>{this.props.hit.webformatWidth} x {this.props.hit.webformatHeight}</div>
